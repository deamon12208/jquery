...
<project path="" name="Ext Examples" author="Jack Slocum" version="1.0 Alpha 2" copyright="Ext - JS Library $version&#xD;&#xA;Copyright(c) 2006-2007, $author." output="F:\htdocs\deploy\ext-1.0-alpha1\examples" source="True" source-dir="$output" minify="False" min-dir="$output\build" doc="False" doc-dir="$output\docs" master="true" master-file="$output\yui-ext.js" zip="true" zip-file="$output\yuo-ext.$version.zip">
  <directory name="" />
