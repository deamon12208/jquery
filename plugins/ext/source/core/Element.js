...
El.prototype = {
    ...
    * @return {Ext.Element} this
     ...
     * @param {<i>Boolean</i>} local (optional) True to get the local (element top/left-relative) anchor position instead of page coordinates
    ...
    /**
     * Aligns this element with another element relative to the specified anchor points. The position
