 ...
 * @param {<i>Ext.Animator</i>} animator (optional) The Animator that will capture this Actor's actions
 * @param {<i>Boolean</i>} selfCapture (optional) Whether this actor should capture its own actions to support self playback without an animator (defaults to false)
 */
