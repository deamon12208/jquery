...
if (isset($_POST) && !empty($_POST) && (!empty($_POST['files']) || isset($_POST['jquery']))) {
  ...
  if (isset($_POST['jquery']) && $_POST['jquery'] != false) {
...
<html>
  <head>
    ...
    <link rel="stylesheet" href="../../../themes/light/light.tabs.css" type="text/css" />
    -->
	  <script type="text/javascript" charset="utf-8">
	  $(document).ready(function() {
	    $('.plugins').download($.ui.plugins).find('.downloadChooser').tabs();
    ...
    <style type="text/css" media="screen">
      #themes li.selected, #plugins li.selected, #settings li.selected {
        color: #2E4336;
        font-weight: bold;
      }
      .tabs-container {
